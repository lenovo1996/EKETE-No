                    ...
                    <div style={{ width: '100%', overflowY: 'scroll' }}>
                      <div className={styles['container']}>
                        ...
                        <Form layout="horizontal" labelCol={{ span: 4 }} wrapperCol={{ span: 24 }}>
                          ...
                          <div className={styles['width-input']} style={{ marginLeft: '18%' }}>
                            <p>
                              ...
                              thể đổi tên mình 2 lần trong vòng 14 ngày.Tìm hiểu thêm.
                            </p>
                          </div>
                      ...
                      <div className={styles['container-accuracy']}>
                        <div className={styles['container-guide']}>
                          <div className={styles['container-item']}>
                            ...
                            <p>
                              Được tạo cửa hàng và sử dụng miễn phí phần mềm quản lý bán hàng Đảm
                              bảo hoàn toàn độ tin cậy đối với khách hàng và cửa hàng.
                            </p>
                            <p>
                              Quá trình thanh toán nhanh hơn, các vấn đề tài khoản hay khó khăn khi
                              làm việc có thể được giải quyết nhanh chóng.
                            </p>
                          </div>
                          <div className={styles['container-item']}>
                            <p className={styles['title']}>Chụp CMND như thế nào cho đúng cách?</p>
                            <p>1. CMND được chụp chính diện, không nghiêng ngả.</p>
                            <p> 2. Chụp trên nền mầu trắng, không bị xen lẫn chữ hay hình vẽ. </p>
                            <p>4. Xoay ảnh đúng chiều đọc được khi chụp xong.</p>
                            <p>3. Ảnh chụp CMND phải thấy hết toàn bộ CMND, không bị cắt </p>
                          </div>
                          <div className={styles['container-item']}>
                            <p className={styles['title']}> Làm cách nào để xác thực CMND?</p>
                            <p>Scan và đăng lên Ảnh CMND cả 2 mặt.</p>
                            <p>Điền đầy đủ, chính xác Số CMND, Ngày cấp, Nơi cấp.</p>
                            <p> Bấm nút Lưu thông tin CMND.</p>
                            <p> Bấm nút Xác thực CMND.</p>
                            <p> Ekata sẽ xác thực trong vòng 72 tiếng.</p>
                          </div>
                        </div>
                        <div
                              ...
                              <div>
                                <Form.Item className={styles['width-input-xt']}>
                                  <Dragger>
                                    ...
                                    <p className="ant-upload-text">Mặt trước</p>
                                    <p className="ant-upload-hint">Hình mặt trước của thẻ</p>
                                  </Dragger>
                                </Form.Item>
                                <Form.Item label="Mã số ID">
                                  <Input
                                    className={styles['width-input']}
                              ...
                              <div>
                                <Form.Item className={styles['width-input-xt']}>
                                  <Dragger>
                                    ...
                                    <p className="ant-upload-text">Mặt sau</p>
                                    <p className="ant-upload-hint">Hình mặt sau của thẻ</p>
                                  </Dragger>
                                </Form.Item>
