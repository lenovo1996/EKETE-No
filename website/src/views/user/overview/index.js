    ...
    <div className={styles['container-layout']}>
      <div className={styles['container-content']}>
        ...
        <div className={styles['container-top10']}>
            ...
            <div style={{ width: '100%', overflowY: 'scroll'}} className={styles['top-list-business']}>
              <List>
                <List.Item>
                  <List.Item.Meta
                    avatar={
                    ...
                    title={<a className={styles['top-business-item-title']}>Benny Kenn</a>}
                    description="Chất lượng tạo nên thương hiệu EKETE"
                  />
                  <div>
                    <a style={{color: '#0bb2fb', fontWeight: 600}}> + Theo dõi</a>
                  </div>
                </List.Item>
                <List.Item>
                  <List.Item.Meta
